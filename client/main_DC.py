...
class MainFrame(wx.Frame):
	...
	def place_buttons(self):
		...
		self.connect_button = wx.BitmapButton(self, -1, self.connect_skin, pos=(int(width*0.65),int(height*0.3)), size=(510,130))
		...
		self.options_button = wx.BitmapButton(self, -1, self.options_skin, pos=(int(width*0.65),int(height*0.5)), size=(510,130))
		...
		self.quit_button = wx.BitmapButton(self, -1, self.quit_skin, pos=(int(width*0.65),int(height*0.7)), size=(510,130))
